    ...
    return (
        ...
        <div className="menubar-area">
            <div className="toolbar-inner menubar-nav">
                <Link to="/notification" className={`nav-link ${menu=="notification" && "active"}`}>
                ...
                <Link to="/" className={`nav-link ${!menu && "active"}`}>
                ...
                <Link to="/profile" className={`nav-link ${menu=="profile" && "active"}`}>
